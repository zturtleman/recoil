...
{
    s_preferences.crosshair.curvalue		= (int)Cvar_VariableValue( "cg_drawCrosshair" ) % NUM_CROSSHAIRS;
    ...
    s_preferences.wallmarks.curvalue		= Cvar_VariableValue( "cg_marks" ) != 0;
    s_preferences.identifytarget.curvalue	= Cvar_VariableValue( "cg_drawCrosshairNames" ) != 0;
    s_preferences.dynamiclights.curvalue	= Cvar_VariableValue( "r_dynamiclight" ) != 0;
    s_preferences.highqualitysky.curvalue	= Cvar_VariableValue ( "r_fastsky" ) == 0;
    s_preferences.synceveryframe.curvalue	= Cvar_VariableValue( "r_finish" ) != 0;
    s_preferences.forcemodel.curvalue		= Cvar_VariableValue( "cg_forcemodel" ) != 0;
    s_preferences.drawteamoverlay.curvalue	= Com_Clamp( 0, 3, Cvar_VariableValue( "cg_drawTeamOverlay" ) );
...
static void Preferences_Event( void* ptr, int notification )
{
    ...
    case ID_CROSSHAIR:
        ...
        Cvar_SetValue( "cg_drawCrosshair", s_preferences.crosshair.curvalue );
        break;
    ...
    case ID_HIGHQUALITYSKY:
        Cvar_SetValue( "r_fastsky", !s_preferences.highqualitysky.curvalue );
        break;
    ...
    case ID_WALLMARKS:
        Cvar_SetValue( "cg_marks", s_preferences.wallmarks.curvalue );
        break;

    case ID_DYNAMICLIGHTS:
        Cvar_SetValue( "r_dynamiclight", s_preferences.dynamiclights.curvalue );
        break;

    case ID_IDENTIFYTARGET:
        Cvar_SetValue( "cg_drawCrosshairNames", s_preferences.identifytarget.curvalue );
        break;

    case ID_SYNCEVERYFRAME:
        Cvar_SetValue( "r_finish", s_preferences.synceveryframe.curvalue );
        break;

    case ID_FORCEMODEL:
        Cvar_SetValue( "cg_forcemodel", s_preferences.forcemodel.curvalue );
        break;

    case ID_DRAWTEAMOVERLAY:
        Cvar_SetValue( "cg_drawTeamOverlay", s_preferences.drawteamoverlay.curvalue );
        break;
...
static void Crosshair_Draw( void *self )
{
    ...
    UI_DrawHandlePic( x + SMALLCHAR_WIDTH, y - 4, 24, 24, s_preferences.crosshairShader);
}
