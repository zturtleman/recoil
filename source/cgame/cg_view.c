...
void CG_DrawActiveFrame( int serverTime, stereoFrame_t stereoView, qboolean demoPlayback )
{
    ...
    if ( cg_stats->integer )
    {
        Com_Printf( "cg.clientFrame:%i [%f %f %f] [%f %f %f]\n", cg.clientFrame, cg.refdef.viewaxis[0][0], cg.refdef.viewaxis[0][1], cg.refdef.viewaxis[0][2], cg.refdef.vieworg[0], cg.refdef.vieworg[1], cg.refdef.vieworg[2] );
    }
