...
static void Demos_MenuInit( void )
{
    ...
    Com_sprintf(extension, sizeof(extension), "dm_%d", (int)Cvar_VariableValue( "protocol" ) );
    s_demos.list.numitems			= FS_GetFileList( "demos", extension, s_demos.names, NAMEBUFSIZE );
...
void Demos_Cache( void )
{
    ...
    RE_RegisterShaderNoMip( ART_GO0 );
    RE_RegisterShaderNoMip( ART_GO1 );
    RE_RegisterShaderNoMip( ART_FRAMEL );
    RE_RegisterShaderNoMip( ART_FRAMER );
    RE_RegisterShaderNoMip( ART_ARROWS );
    RE_RegisterShaderNoMip( ART_ARROWLEFT );
    RE_RegisterShaderNoMip( ART_ARROWRIGHT );
}
