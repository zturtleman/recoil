...
static void UI_DrawBannerString2( int x, int y, const char* str, vec4_t color )
{
    ...
    while ( *s )
    {
        ...
        else if ( ch >= 'A' && ch <= 'Z' )
        {
            ...
            RE_StretchPic( ax, ay, aw, ah, fcol, frow, fcol+fwidth, frow+fheight, uis.charsetPropB );
...
static void UI_DrawString2( int x, int y, const char* str, vec4_t color, int charw, int charh )
{
    ...
    while ( *s )
    {
        ...
        if (ch != ' ')
        {
            frow = (ch>>4)*0.0625;
            fcol = (ch&15)*0.0625;
            RE_StretchPic( ax, ay, aw, ah, fcol, frow, fcol + 0.0625, frow + 0.0625, uis.charset );
        }
...
void UI_FillRect( float x, float y, float width, float height, const float *color )
{
    ...
    UI_AdjustFrom640( &x, &y, &width, &height );
    RE_StretchPic( x, y, width, height, 0, 0, 0, 0, uis.whiteShader );
...
void UI_DrawRect( float x, float y, float width, float height, const float *color )
{
    ...
    RE_StretchPic( x, y, width, 1, 0, 0, 0, 0, uis.whiteShader );
    RE_StretchPic( x, y, 1, height, 0, 0, 0, 0, uis.whiteShader );
    RE_StretchPic( x, y + height - 1, width, 1, 0, 0, 0, 0, uis.whiteShader );
    RE_StretchPic( x + width - 1, y, 1, height, 0, 0, 0, 0, uis.whiteShader );
