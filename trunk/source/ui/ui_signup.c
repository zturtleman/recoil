...
static void Signup_MenuEvent( void* ptr, int event )
{
    ...
    case ID_SIGNUP:
        ...
        // set name
        //Cvar_Set( "name", s_signup.name_box.field.buffer );
        /*
        Cvar_Set( "rank_name", s_signup.name_box.field.buffer );
        Cvar_Set( "rank_pwd", s_signup.password_box.field.buffer );
        */
...
{
    RE_RegisterShaderNoMip( SIGNUP_FRAME );
}
