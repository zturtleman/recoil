...
static void UI_RemoveBotsMenu_SetBotNames( void )
{
    ...
    {
        GetConfigString( CS_PLAYERS + removeBotsMenuInfo.botClientNums[removeBotsMenuInfo.baseBotNum + n], info, MAX_INFO_STRING );
...
void UI_RemoveBots_Cache( void )
{
    ...
    RE_RegisterShaderNoMip( ART_DELETE0 );
    RE_RegisterShaderNoMip( ART_DELETE1 );
}
