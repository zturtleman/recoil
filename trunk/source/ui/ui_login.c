...
static void Login_MenuEvent( void* ptr, int event )
{
    ...
    case ID_LOGIN:
        // set name								``
        //Cvar_Set( "name", s_login.name_box.field.buffer );
        /*
        Cvar_Set( "rank_name", s_login.name_box.field.buffer );
        Cvar_Set( "rank_pwd", s_login.password_box.field.buffer );
        */
...
{
    RE_RegisterShaderNoMip( LOGIN_FRAME );
}
