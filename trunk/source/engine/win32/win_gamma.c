...
void WG_CheckHardwareGamma( void )
{
    ...
    if ( !r_ignorehwgamma->integer )
    {
        ...
        if ( glConfig.deviceSupportsGamma )
        {
            ...
            {
                glConfig.deviceSupportsGamma = qfalse;
                CL_RefPrintf( PRINT_WARNING, "WARNING: device has broken gamma support, generated gamma.dat\n" );
            }
            ...
            if ( ( HIBYTE( s_oldHardwareGamma[0][181] ) == 255 ) )
            {
                ...
                CL_RefPrintf( PRINT_WARNING, "WARNING: suspicious gamma tables, using linear ramp for restoration\n" );
