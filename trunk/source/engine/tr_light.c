...
static void LogLight( trRefEntity_t *ent )
{
    ...
    CL_RefPrintf( PRINT_ALL, "amb:%f/%f  dir:%f\n", max1, tr.identityLight, max2 );
}
...
void R_SetupEntityLighting( const trRefdef_t *refdef, trRefEntity_t *ent )
{
    ...
    // clamp ambient
    VectorScale( ent->ambientLight, (1.0/256.0), ent->ambientLight );
    VectorScale( ent->directedLight, (1.0/256.0), ent->directedLight );
    ...
    ent->ambientLightInt[0] = ( ent->ambientLight[0] );
    ent->ambientLightInt[1] = ( ent->ambientLight[1] );
    ent->ambientLightInt[2] = ( ent->ambientLight[2] );
    ent->ambientLightInt[3] = 1.0;
