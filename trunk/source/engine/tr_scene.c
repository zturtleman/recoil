...
void RE_AddPolyToScene( qhandle_t hShader, int numVerts, const polyVert_t *verts, int numPolys )
{
    ...
    if ( !hShader )
    {
//        CL_RefPrintf( PRINT_WARNING, "WARNING: RE_AddPolyToScene: NULL poly shader\n");
        return;
    }
    ...
    for ( j = 0; j < numPolys; j++ )
    {
        if ( r_numpolyverts + numVerts > max_polyverts || r_numpolys >= max_polys )
        {
            ...
            */
            CL_RefPrintf( PRINT_DEVELOPER, "WARNING: RE_AddPolyToScene: r_max_polys or r_max_polyverts reached\n");
            return;
        }
        ...
        Com_Memcpy( poly->verts, &verts[numVerts*j], numVerts * sizeof(polyVert_t) );
