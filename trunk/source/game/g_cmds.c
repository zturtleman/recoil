...
void Cmd_Give_f (gentity_t *ent)
{
    ...
    {
        ent->client->ps.weaponAmmo[0] = 999;
        ent->client->ps.weaponAmmo[1] = 999;
        ent->client->ps.weaponAmmo[2] = 999;
        if (!give_all)
            return;
    }
...
void Cmd_CallVote_f( gentity_t *ent )
{
    ...
    {
        SV_GameSendServerCommand( ent-g_entities, "print \"Invalid vote string.\n\"" );
        SV_GameSendServerCommand( ent-g_entities, "print \"Vote commands are: map_restart, nextmap, map <mapname>, g_gametype <n>, kick <player>, clientkick <clientnum>, g_doWarmup, timelimit <time>, fraglimit <frags>.\n\"" );
        return;
    }
...
void Cmd_Stats_f( gentity_t *ent )
{
    /*
    	...
    	max = botlib_export->aas.AAS_PointReachabilityAreaIndex( NULL );
